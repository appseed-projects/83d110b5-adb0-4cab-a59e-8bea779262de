...
- Timestamp: `2022-06-07 14:37`
- Build ID: `83d110b5-adb0-4cab-a59e-8bea779262de`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/83d110b5-adb0-4cab-a59e-8bea779262de.git
$ cd 83d110b5-adb0-4cab-a59e-8bea779262de
```
